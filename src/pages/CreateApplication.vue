  ...
  <div class="content">
    <div class="content application-panel flex flex-column gap-3 justify-content-center m-auto mb-4 montserrat-font">
      <Panel 
          ...
          :class="{'bg-red-100' : !appStore.isDarkMode, 'bg-red-900 opacity-50' : appStore.isDarkMode}
        ">
...
const isFormValid = computed(() => {
  return formValidation.value.header && 
...
const saveApplication = async () => {
  ...
  if (!isFormValid.value) {
    toast.add({ severity: 'warn', summary: 'Ошибка', detail: 'Пожалуйста, заполните все необходимые поля', life: 3000 });
    return;
  }
