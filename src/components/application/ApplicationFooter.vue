<template>
  <Panel class="panel-no-header"> 
    <div class="">
      ...
      <Message v-if="!(!props.showValidationErrors || isValid)" severity="error" icon="pi pi-times-circle">Пожалуйста, примите все условия</Message>
    </div>
  </Panel>
</template>
...
const isValid = computed(() => {
  return props.modelValue.hostel_policy_accepted && 
