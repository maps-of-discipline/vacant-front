    ...
    <div class="">
      <div class="flex flex-row gap-2 mb-2">
        ...
        <label for="hostel_policy_accepted">
          Ознакомлен, что общежитие предоставляется при наличии свободного жилого фонда после заявки
          в личном кабинете обучающегося в соответствии с очередностью
        </label>
      </div>
      <div
      ...
      >
        ...
        <label for="paid_policy_accepted">
          В случае невозможности перевода на бюджетную основу прошу рассмотреть возможность платную
          договорную основу
        </label>
      </div>
      <div class="flex flex-row gap-2 mb-2">
      ...
      <div class="flex flex-row gap-2 mb-2">
        ...
        <label for="no_restrictions_policy_accepted">
          Подтверждаю отсутствие ограничений, предусмотренных для освоения образовательной программы
          за счет бюджетный оссигнований
        </label>
      </div>
      <div class="flex flex-row gap-2 mb-2">
        <Checkbox
